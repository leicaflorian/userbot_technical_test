...
var _a, _FileParser_repeatedWordsLimit, _FileParser_instance, _FileParser_fileContent, _FileParser_wordsRegex;
...
class FileParser {
    constructor() {
        ...
        _FileParser_wordsRegex.set(this, '\\w-òàùèéì'
        // ************************************************************************
        // STATIC METHODS
        // ************************************************************************
        /**
     ...
     */
    get words() {
        const regex = new RegExp(`[${__classPrivateFieldGet(this, _FileParser_wordsRegex, "f")}]+`, 'gi');
        const words = __classPrivateFieldGet(this, _FileParser_fileContent, "f").match(regex);
     ...
     */
    get spacesCount() {
        return __classPrivateFieldGet(this, _FileParser_fileContent, "f").match(/\s/g).length;
    }
    /**
     ...
     */
    get symbolsCount() {
        const regex = new RegExp(`[^\\s${__classPrivateFieldGet(this, _FileParser_wordsRegex, "f")}]`, 'gi');
        return __classPrivateFieldGet(this, _FileParser_fileContent, "f").match(regex).length;
    }
    /**
    ...
    getLettersCount(includeSpaces, includeSymbols) {
        ...
        toReturn += __classPrivateFieldGet(this, _FileParser_fileContent, "f").match(new RegExp(`[${__classPrivateFieldGet(this, _FileParser_wordsRegex, "f")}]`, 'gi')).length;
        return toReturn;
    }
}
exports.FileParser = FileParser;
_a = FileParser, _FileParser_fileContent = new WeakMap(), _FileParser_wordsRegex = new WeakMap();
/**
